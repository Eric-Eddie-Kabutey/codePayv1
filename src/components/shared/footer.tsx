        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-[#4a4a4a]">
            ...
            <div className="mt-12 flex gap-3">
              {footer.social.map((item) => (
                <a
                  ...
                  className="text-gray-300 hover:text-white transition-colors border border-gray-500 hover:border-gray-300 rounded-xl p-1.5"
                >
          ...
          <div className="p-8 lg:p-12 flex flex-col">
            ...
            <ul className="space-y-4 mb-16">
              <li><Link href="/contact" className="text-[15px] text-gray-300 hover:text-white transition-colors rounded-xl">Talk to an Expert {'>'}</Link></li>
              <li><Link href="/support" className="text-[15px] text-gray-300 hover:text-white transition-colors rounded-xl">Customer Support {'>'}</Link></li>
              <li><Link href="/press" className="text-[15px] text-gray-300 hover:text-white transition-colors rounded-xl">Press {'>'}</Link></li>
            </ul>
            ...
            <div className="mt-auto">
              ...
              <form className="flex flex-col gap-4">
                ...
                <button
                  type="submit"
                  className="w-full border border-gray-400 py-2.5 text-sm font-medium text-white hover:bg-white hover:text-black transition-colors rounded-xl"
                >
                  Submit
                </button>
              </form>
